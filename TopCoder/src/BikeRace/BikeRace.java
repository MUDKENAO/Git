	/**
	Problem statement
	https://community.topcoder.com/stat?c=problem_statement&pm=2958
	 
	* @author Z.SUN
	* @version 2018年6月21日 上午10:38:34
	*/
...
public class BikeRace {
	...
	public static void main(String args[]){
		int track = 5000;
		String name[] = {"TOM","TOMMY","BILL","SPEEDY","JIMMY"};
		int start[] = {100,120,110,0,1000};
		int speed[] = {50,50,50,50,50};
	
		System.out.println(Arrays.toString(new BikeRace().eliminated(track, name, start, speed)));
	}
}
