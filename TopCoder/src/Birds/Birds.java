/**
Problem statement
https://community.topcoder.com/stat?c=problem_statement&pm=330

* @author Z.SUN
* @version 2018年7月13日 上午9:44:11
*/
...
public class Birds {
	...
	boolean isRegionAccept(int begin1, int end1, int begin2,
			int end2) {
	...
	public static void main(String args[]) {
		String[] birdMoves = { "200,400,7,1", "100,0,1,1",
				"200,200,3,1", "0,400,11,1", "407,308,5,1",
				"100,600,9,1" };
		System.out.println(
				new Birds().isMigratory(birdMoves));
	}
}
